...
const clean = (raw: string): string => raw.replace(/<think>[\s\S]*?<\/think>/g, '').trim();
 ...
 */
const LearningAssistant = React.memo<LearningAssistantProps>(
  ({ explanation, selectedText, onBackToSubtitles }) => {
